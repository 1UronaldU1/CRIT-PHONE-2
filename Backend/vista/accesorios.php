...
if(isset($_GET['categoria'])){
    ...
    $sql="SELECT idProducto, NombreProducto, descripcion, imagen, idCategoria, IdMarca,Cantidad,precio, estado FROM producto where idCategoria=$categoria and estado=1 order by idProducto desc LIMIT 8";
}else{
...
<body class="sub_page">
  ...
  <section class="shop_section layout_padding">
      ...
      ?>
        ...
        <div class="col-md-6 ">
          <div class="box">
            ...
            <a href="../vista/detalle_producto.php?id=<?php echo $fila['idProducto'];?>">
    ...
    <div class="btn-box d-block text-center"><a href="accesorios.php">Ver todo</a></div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3 footer-col">
          ...
          <div class="footer_contact">
            ...
            <div class="contact_link_box">
              ...
              <a href="https://www.google.com/maps/place/SENATI+Surquillo/@-12.1143853,-76.9998794,16.42z/data=!4m14!1m8!3m7!1s0x9105c7efebc5a383:0x4f71fb1c5cd4ae12!2sSENATI+Surquillo!8m2!3d-12.1163729!4d-76.9976411!9m1!1b1!3m4!1s0x9105c7efebc5a383:0x4f71fb1c5cd4ae12!8m2!3d-12.1163729!4d-76.9976411">
              ...
              <a href="https://api.whatsapp.com/send?phone=51936618978&text=Si%20necesita%20ayuda,llamarm%C3%A9">
                <i class="fa fa-phone" aria-hidden="true"></i>

                <span>Llamar +51 970592509</span>

              </a>

              <a href="https://www.n.artific@gmail.com">
        ...
        <div class="col-md-6 col-lg-3 footer-col">
          ...
          <div class="footer_contact">
            ...
            <form action="#"><button type="submit">Volver al inicio</button></form>
      ...
      <div class="footer-info">
        ...
        <p>
          ...
          <a href="https://www.facebook.com/RonaldUvirgo">OnePice.</a>
        </p>
