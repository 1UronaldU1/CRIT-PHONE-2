...
function Header()
{
    ...
    $this->Cell(50);
    // Título
    $this->Cell(80,10,'LISTADO DE CLIENTE',0,0,'C');
    // Salto de línea
	...
	$this->Cell(35,10,'NOMBRE CLIENTE',1,0,'C',1);
	$this->Cell(50,10,'USUARIO',1,0,'C',1);
    $this->Cell(30,10,'TELEFONO',1,0,'C',1);
    $this->Cell(40,10,'DIRRECCION',1,0,'C',1);
...
while ($row= $resultado->fetch_assoc()) {
	$pdf->Cell(10,10,utf8_decode($row['IDCliente']),1,0,'C',1);
	$pdf->Cell(35,10,utf8_decode($row['NombreCliente']),1,0,'C',0);
	$pdf->Cell(50,10,utf8_decode($row['UsuarioCliente']),1,0,'C',1);
    $pdf->Cell(30,10,utf8_decode($row['Telefono']),1,0,'C',1);
    $pdf->Cell(40,10,utf8_decode($row['Dirreccion']),1,0,'C',1);
